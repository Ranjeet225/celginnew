									...
									<div class="product-description">
										<div class="body-area">
												...
												<div class="col-lg-12">
													<select id="cat" name="brand_id" required="">
														...
														@foreach($brand as $value)
															<option data-href="" value="{{ $value->id }}">{{$value->name}}</option>
														@endforeach
													</select>
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-lg-12">
													<input name="weight"  type="number" class="input-field" placeholder="e.g 20" value="" min="0">
												</div>
											</div>
											<div class="row">
												<div class="col-lg-12">
												...
												<div class="col-lg-12">
													<input name="product_tax"  type="number" class="input-field" placeholder="18%" value="" min="0">
												</div>
											</div>
											<div class="row">
												<div class="col-lg-12">
												...
												<div class="col-lg-12">
													<input name="expiry_date"  type="date" class="input-field" placeholder="18%" value="" min="0">
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-lg-12">
													<div class="text-editor">
														<textarea class="nic-edit" name="benefits" ></textarea>
													</div>
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-lg-12">
													<div class="text-editor">
														<textarea class="nic-edit" name="how_to_use"></textarea>
													</div>
												</div>
											</div>
											<div class="row">
