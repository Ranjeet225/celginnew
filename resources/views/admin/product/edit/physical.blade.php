								...
								<div class="body-area">
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<select id="cat" name="category_id" required="">
												...
												@foreach($cats as $cat)
												<option data-href="{{ route('admin-subcat-load',$cat->id) }}" value="{{$cat->id}}" {{$cat->id == $data->category_id ?
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<select id="subcat" name="subcategory_id">
												...
												@else
												@foreach($data->category->subs as $sub)
												<option data-href="{{ route('admin-childcat-load',$sub->id) }}" value="{{$sub->id}}" {{$sub->id == $data->subcategory_id ?
										...
										<div class="col-lg-12">
											<select id="cat" name="brand_id" required="">
												...
												@foreach($brand as $value)
													<option data-href="" value="{{ $value->id }}" {{$value->id == $data->brand_id ?
												...
												<div class="row">
													<div class="col-lg-5">
														<div class="custom-control custom-checkbox">
															...
															in_array($option->name,
															$selectedAttrs["$inName"]["values"]))
															checked
															@php
															$checked = 1;
															@endphp
															...
															@endif
															>
															<!-- <label class="custom-control-label" for="{{ $catAttribute->input_name }}{{$option->id}}">
																{{
																$option->name }}</label> -->
														</div>
													</div>
														...
														<div class="row">
															...
															<div class="col-10">
																<div class="price-container">
																	...
																	<input type="text" class="input-field price-input" id="{{ $catAttribute->input_name }}{{$option->id}}_price" data-name="{{ $catAttribute->input_name }}_price[]" placeholder="0.00 (Additional Price)" value="{{ !empty($selectedAttrs["
												...
												<div class="row">
													<div class="col-lg-5">
														<div class="custom-control custom-checkbox">
															...
															<label class="custom-control-label" for="{{ $subAttribute->input_name }}{{$option->id}}">{{
																$option->name }}</label>
														</div>
													</div>
													<div class="col-lg-7 {{ $subAttribute->price_status == 0 ? 'd-none' : '' }}">
														<div class="row">
															...
															<div class="col-10">
																<div class="price-container">
																	<span class="price-curr">{{ $sign->sign }}</span>
																	<input type="text" class="input-field price-input" id="{{ $subAttribute->input_name }}{{$option->id}}_price" data-name="{{ $subAttribute->input_name }}_price[]" placeholder="0.00 (Additional Price)" value="{{ !empty($selectedAttrs["
																		$inName"]['prices'][$i]) && $checked==1 ?
																		round($selectedAttrs["$inName"]['prices'][$i]*
																		$sign->value , 2) : '' }}">
																</div>
												...
												<div class="row">
													<div class="col-lg-5">
														<div class="custom-control custom-checkbox">
															...
															<label class="custom-control-label" for="{{ $childAttribute->input_name }}{{$option->id}}">{{
																$option->name }}</label>
														</div>
													</div>
													...
													<div class="col-lg-7 {{ $childAttribute->price_status == 0 ? 'd-none' : '' }}">
														<div class="row">
															...
															<div class="col-10">
																<div class="price-container">
																	<span class="price-curr">{{ $sign->sign }}</span>
																	<input type="text" class="input-field price-input" id="{{ $childAttribute->input_name }}{{$option->id}}_price" data-name="{{ $childAttribute->input_name }}_price[]" placeholder="0.00 (Additional Price)" value="{{ !empty($selectedAttrs["
																		$inName"]['prices'][$i]) && $checked==1 ?
																		round($selectedAttrs["$inName"]['prices'][$i]*
																		$sign->value , 2) : '' }}">
																</div>
										...
										<div class="row">
											...
											<div class="col-lg-12">
												<div class="checkbox-wrapper">
													<input type="checkbox" name="measure_check" class="checkclick1" id="allowProductMeasurement" value="1" {{ $data->measure == null
													? '' : 'checked' }}>
										...
										<div class="col-lg-12">
											<ul class="list">
												<li>
													...
													<label for="conditionCheck">{{ __('Allow Product Condition')
														}}</label>
												</li>
											</ul>
										</div>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<ul class="list">
												<li>
													<input class="checkclick1" name="preordered_check" type="checkbox" id="preorderedCheck" value="1" {{ $data->preordered != 0 ?
													"checked":"" }}>
													<label for="preorderedCheck">{{ __('Allow Product Preorder')
														}}</label>
												</li>
											</ul>
										</div>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<ul class="list">
												<li>
													<input class="checkclick1" name="minimum_qty_check" type="checkbox" id="check111" value="1" {{$data->minimum_qty != null ?
													"checked":""}}>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<ul class="list">
												<li>
													<input class="checkclick1" name="shipping_time_check" type="checkbox" id="check1" value="1" {{$data->ship != null ?
													"checked":""}}>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input name="weight"  type="number" class="input-field" placeholder="e.g 20" value="{{$data->weight}}" min="0">
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input name="product_tax"  type="number" class="input-field" placeholder="18%" value="{{$data->product_tax}}" min="0">
										</div>
									</div>
														...
														<div class="row">
															...
															<div class="col-md-3 col-sm-6">
																...
																<select name="color[]" class="input-field color-name">
																	...
																	<option value="{{ $ct }}" style="background-color:{{ $ct }}" {{
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<ul class="list">
												<li>
													<input class="checkclick1" name="whole_check" type="checkbox" id="whole_check" value="1" {{ !empty($data->whole_sell_qty) ?
													"checked":"" }}>
													<label for="whole_check">{{ __('Allow Product Whole Sell')
														}}</label>
												</li>
											</ul>
										</div>
									...
									<div class="">
										<div class="row">
											<div class="col-lg-12">
												<div class="left-area">
													<h4 class="heading">{{ __('Cross Showing Product By Current
														Category') }}*</h4>
												</div>
											</div>
											<div class="col-lg-12">
												@php
												$cross_products = App\Models\Product::where('category_id',
												$data->category_id)->where('id', '!=', $data->id)->get();
												...
												<select name="cross_products[]" multiple id="cross_product" class="select2">
													...
													<option value="{{$item->id}}" {{in_array($item->
														id,$cross_product_id) ? 'selected' : ''}}>{{$item->name}}
													</option>
													@endforeach
												</select>
											</div>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<div class="text-editor">
												<textarea class="nic-edit" name="benefits" >{{$data->benefits}}</textarea>
											</div>
										</div>
									</div>
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="left-area">
													<h4 class="heading">
														{{ __('Product How to use') }}*
													</h4>
												</div>
											</div>
											<div class="col-lg-12">
												<div class="text-editor">
													<textarea class="nic-edit" name="how_to_use">{{$data->how_to_use}}</textarea>
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="checkbox-wrapper">
												<input type="checkbox" name="seo_check" value="1" class="checkclick" id="allowProductSEO" {{ ($data->meta_tag != null ||
