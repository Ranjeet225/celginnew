      ...
      <div class="col-12 col-lg-5 col-md-8">
        <div class="summary entry-summary">
          <div class="summary-inner">
            ...
            <input type="hidden" id="product_tax" value="{{ $productt->product_tax }}">
      ...
      <div class="col-lg-3 col-md-4">
        <div class="pro-details-sidebar-item mb-4">
          ...
          <h5>@if( $productt->user_id != 0)
            ...
            <br>
            <a class="verify-link" href="javascript:;" data-toggle="tooltip" data-placement="top" title="" data-original-title="{{ __('Verified') }}">
