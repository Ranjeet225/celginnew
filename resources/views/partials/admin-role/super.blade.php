...
<li>
    <a href="#testimonial" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
        <i class="fas fa-fw fa-newspaper"></i>{{ __('Testimonial') }}
    </a>
    <ul class="collapse list-unstyled" id="testimonial" data-parent="#accordion">
        <li>
            <a href="{{ route('admin-ctestimonial-index') }}"><span>{{ __('Categories') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-testimonial-index') }}"><span>{{ __('Posts') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-gs-testimonial-settings') }}"><span>{{ __('Testimonial Settings') }}</span></a>
        </li>
    </ul>
</li>
<li>
    ...
    <ul class="collapse list-unstyled" id="general" data-parent="#accordion">
        ...
        <li>
         ...
         <li>
            <a href="{{ route('admin-gs-referral') }}"><span>{{__('Referral Program')}}</span></a>
        </li>
        <li>
...
<li>
    ...
    <ul class="collapse list-unstyled" id="menu" data-parent="#accordion">
        <li>
          ...
          <li>
            <a href="{{ route('admin-collaboration-index') }}"><span>{{ __('Collaboration') }}</span></a>
        </li>
        <li>
...
<li>
    <a href="{{ route('mlm-users') }}" class="wave-effect"><i
            class="fa fa-user mr-2"></i>{{ __('MLM Users') }}</a>
</li>
