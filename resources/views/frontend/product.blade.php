         ...
         <div class="col-lg-8">
            <div class="section-head border-bottom">
               <div class="woocommerce-tabs wc-tabs-wrapper ps-0">
                  <ul class="nav nav-pills wc-tabs" id="pills-tab-one" role="tablist">
                     ...
                     <li class="nav-item" role="presentation">
                        <a class="nav-link " id="pills-benefits-one-tab" data-bs-toggle="pill"
                           href="#pills-benefits-one" role="tab" aria-controls="pills-benefits-one"
                           aria-selected="true">{{ __('Benefits') }}</a>
                     </li>
                     <li class="nav-item" role="presentation">
                        <a class="nav-link" id="pills-how-to-use-one-tab" data-bs-toggle="pill"
                           href="#pills-how-to-use-one" role="tab" aria-controls="pills-how-to-use-one"
                           aria-selected="true">{{ __('How to use') }}</a>
                     </li>
                     <li class="nav-item" role="presentation">
                        <a class="nav-link" id="pills-ingredients-tab" data-bs-toggle="pill"
                           href="#pills-ingredients-one" role="tab" aria-controls="pills-ingredients-one"
                           aria-selected="true">{{ __('Ingredients') }}</a>
                     </li>
                     <li class="nav-item" role="presentation">
            ...
            <div class="woocommerce-tabs wc-tabs-wrapper ps-0 mt-0">
               <div class="tab-content" id="pills-tabContent-one">
                  <!-- Description Tab -->
                  <div class="tab-pane fade show active woocommerce-Tabs-panel woocommerce-Tabs-panel--description mb-5 mt-4"
                       id="pills-description-one" role="tabpanel" aria-labelledby="pills-description-one-tab">
                      @if (strlen(strip_tags($productt->details)) > 150)
                          <p>{{ substr(strip_tags($productt->details), 0, 150) }} 
                              <a href="javascript:;" class="read-more text-primary">...Read More</a>
                          </p>
                  ...
                  <!-- Benefits Tab -->
                  <div class="tab-pane fade mb-5 mt-4" id="pills-benefits-one" role="tabpanel" aria-labelledby="pills-benefits-one-tab">
                      @if (strlen(strip_tags($productt->benefits)) > 150)
                          <p>{{ substr(strip_tags($productt->benefits), 0, 150) }} 
                              <a href="javascript:;" class="read-more">...Read More</a>
                          </p>
                          <div class="full-desc" style="display: none;">
                              {!! clean($productt->benefits , array('Attr.EnableID' => true)) !!}
                          </div>
                      @else
                          {!! clean($productt->benefits , array('Attr.EnableID' => true)) !!}
                      @endif
                  ...
                  <!-- How to Use Tab -->
                  <div class="tab-pane fade mb-5 mt-4" id="pills-how-to-use-one" role="tabpanel" aria-labelledby="pills-how-to-use-one-tab">
                      @if (strlen(strip_tags($productt->how_to_use)) > 150)
                          <p>{{ substr(strip_tags($productt->how_to_use), 0, 150) }} 
                              <a href="javascript:;" class="read-more">...Read More</a>
                          </p>
                          <div class="full-desc" style="display: none;">
                              {!! clean($productt->how_to_use , array('Attr.EnableID' => true)) !!}
                          </div>
                      @else
                          {!! clean($productt->how_to_use , array('Attr.EnableID' => true)) !!}
                      @endif
                  ...
                  <!-- Ingredients Tab -->
                  <div class="tab-pane fade mb-5 mt-4" id="pills-ingredients-one" role="tabpanel" aria-labelledby="pills-ingredients-tab">
                      @if (strlen(strip_tags($productt->ingredients)) > 150)
                          <p>{{ substr(strip_tags($productt->ingredients), 0, 150) }} 
                              <a href="javascript:;" class="read-more">...Read More</a>
                          </p>
                          <div class="full-desc" style="display: none;">
                              {!! clean($productt->ingredients , array('Attr.EnableID' => true)) !!}
                          </div>
                      @else
                          {!! clean($productt->ingredients , array('Attr.EnableID' => true)) !!}
                      @endif
                  ...
                  <div class="tab-pane fade mb-5" id="pills-information-one" role="tabpanel" aria-labelledby="pills-information-one-tab">
                      <div class="row">
                          <div class="col-8">
                              @if (strlen(strip_tags($productt->policy)) > 150)
                                  <p>{{ substr(strip_tags($productt->policy), 0, 150) }} 
                                      <a href="javascript:;" class="read-more">...Read More</a>
                                  </p>
                                  <div class="full-desc" style="display: none;">
              ...
              <!-- JavaScript for handling "Read More" -->
