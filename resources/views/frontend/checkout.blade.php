                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                       <input class="form-control" type="text" name="customer_zip"
                                          ...
                                          value="{{ Auth::check() ? Auth::user()->zip : '' }}" id="zipcode">
                              ...
                              <div class="row">
                                 <div class="col-lg-12 mt-3">
                                    <div class="bottom-area">
                                       ...
                                       <button type="submit" id="final-btn" class="mybtn2">{{ __('Continue') }}</button>
                                    </div>
                                 </div>
                              </div>
                           </div>
               ...
               <div class="order-box">
                  ...
                  <ul class="order-list">
                     ...
                     <li class="tax_show  d-none">
                        ...
                        <P>
                           {{App\Models\Product::convertPrice(array_sum(array_map(function($data) {
