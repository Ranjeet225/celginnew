...
class Product extends Model
{
    ...
    protected $fillable = ['user_id', 'category_id', 'product_type', 'affiliate_link', 'sku', 'subcategory_id', 'childcategory_id', 'attributes', 'name', 'photo', 'size', 'size_qty', 'size_price', 'color', 'details', 'price', 'previous_price', 'stock', 'policy', 'status', 'views', 'tags', 'featured', 'best', 'top', 'hot', 'latest', 'big', 'trending', 'sale', 'features', 'colors', 'product_condition', 'ship', 'meta_tag', 'meta_description', 'youtube', 'type', 'file', 'license', 'license_qty', 'link', 'platform','product_tax', 'region', 'licence_type', 'measure', 'discount_date', 'is_discount', 'whole_sell_qty', 'whole_sell_discount', 'catalog_id', 'slug', 'flash_count', 'hot_count', 'new_count', 'sale_count', 'best_seller_count', 'popular_count', 'top_rated_count', 'big_save_count', 'trending_count', 'page_count', 'seller_product_count', 'wishlist_count', 'vendor_page_count', 'min_price', 'max_price', 'product_page', 'post_count', 'minimum_qty', 'preordered', 'color_all', 'size_all', 'stock_check', 'cross_products','how_to_use','benefits','brand_id','ingredients','expiry_date'];
    ...
    public static function  referralUser(){
        $auth_user_id = Auth::user()->id;
        $sub_user = User::where('reffered_by', $auth_user_id)->pluck('id')->unique();
        $product_orders = Order::whereIn('user_id', $sub_user)->where('status', 'completed')->pluck('user_id')->unique();
        return $product_orders;
    }

    public static function  completeOrder(){
        $auth_user_id = Auth::user()->id;
        $product_orders = Order::whereIn('user_id', [$auth_user_id])->where('status', 'completed')->pluck('user_id')->unique();
        return $product_orders;
    }


    public static function  countReferralUsersForAdmin($id)
    {
        $sub_user = User::where('reffered_by', $id)->pluck('id')->unique();
        $product_orders = Order::whereIn('user_id', $sub_user)->where('status', 'completed')->pluck('user_id')->unique();
        return $product_orders;
    }
