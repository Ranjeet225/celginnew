...
class LanguageController extends AdminBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        file_put_contents(public_path() . 'public_html/final_celigin/resources/lang/' . $data->file, $mydata);
        //--- Logic Section Ends
    ...
    public function importStore(Request $request)
    {
        ...
        $file = fopen(public_path('public_html/assets/temp_files/' . $filename), "r");
    ...
    //   dd(  $file );
        ...
        $mydata = json_encode($new);
        file_put_contents(public_path() . 'public_html/resources/lang/' . $data->file, $mydata);
    ...
    public function edit($id)
    {
        ...
        // dd( $data->file);
        $data_results = file_get_contents(public_path() . 'public_html/resources/lang/' . $data->file);

        // file_get_contents('project/resources/lang/' . $data->file);
    ...
    {
        $data = Language::findOrFail($id);
        // $data_results = file_get_contents('celigin/resources/lang/' . $data->file);
        $data_results = file_get_contents(public_path() . '/resources/lang/' . $data->file);
    ...
    public function update(Request $request, $id)
    {
        ...
        file_put_contents($folder . $data->file, $mydata);
        //--- Logic Section Ends
    ...
    public function destroy($id)
    {
        ...
        if (file_exists(public_path() . '/resources/lang/' . $data->file)) {
