...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'permissions:riders'], function () {
        ...
        // mlm users data 
        Route::get('/mlm-user', 'Admin\UserController@mlm_users')->name('mlm-users');
...
//----------------------------------------------------------------Testimonial Start////////////////
    Route::group(['middleware' => 'permissions:testimonial'], function () {
        ...
        Route::get('/testimonial/datatables', 'Admin\TestimonialController@datatables')->name('admin-testimonial-datatables'); //JSON REQUEST
        ...
        Route::post('/testimonial/create', 'Admin\TestimonialController@store')->name('admin-testimonial-store');
        Route::get('/testimonial/edit/{id}', 'Admin\TestimonialController@edit')->name('admin-testimonial-edit');
        Route::post('/testimonial/edit/{id}', 'Admin\TestimonialController@update')->name('admin-testimonial-update');
        Route::delete('/testimonial/delete/{id}', 'Admin\TestimonialController@destroy')->name('admin-testimonial-delete');

        Route::get('/testimonial/category/datatables', 'Admin\TestimonialCategoryController@datatables')->name('admin-ctestimonial-datatables'); //JSON REQUEST
        Route::get('/testimonial/category', 'Admin\TestimonialCategoryController@index')->name('admin-ctestimonial-index');
        Route::get('/testimonial/category/create', 'Admin\TestimonialCategoryController@create')->name('admin-ctestimonial-create');
        Route::post('/testimonial/category/create', 'Admin\TestimonialCategoryController@store')->name('admin-ctestimonial-store');
        Route::get('/testimonial/category/edit/{id}', 'Admin\TestimonialCategoryController@edit')->name('admin-ctestimonial-edit');
        Route::post('/testimonial/category/edit/{id}', 'Admin\TestimonialCategoryController@update')->name('admin-ctestimonial-update');
        Route::delete('/testimonial/category/delete/{id}', 'Admin\TestimonialCategoryController@destroy')->name('admin-ctestimonial-delete');

        Route::get('/testimonial/blog-settings', 'Admin\TestimonialController@settings')->name('admin-gs-testimonial-settings');
    });
...
Route::group(['middleware' => 'permissions:general_settings'], function () {
    ...
    Route::group(['middleware' => 'permissions:menu_page_settings'], function () {
        ...
        Route::get('/collaboration/datatables', 'Admin\CollaborationController@datatables')->name('admin-collaboration-datatables'); //JSON REQUEST
        Route::get('/collaboration', 'Admin\CollaborationController@index')->name('admin-collaboration-index');
        Route::get('/collaboration/create', 'Admin\CollaborationController@create')->name('admin-collaboration-create');
        Route::post('/collaboration/create', 'Admin\CollaborationController@store')->name('admin-collaboration-store');
        Route::get('/collaboration/edit/{id}', 'Admin\CollaborationController@edit')->name('admin-collaboration-edit');
        Route::post('/collaboration/update/{id}', 'Admin\CollaborationController@update')->name('admin-collaboration-update');
        Route::delete('/collaboration/delete/{id}', 'Admin\CollaborationController@destroy')->name('admin-collaboration-delete');
...
Route::group(['middleware' => 'maintenance'], function () {
    ...
    Route::prefix('user')->group(function () {
        ...
        Route::get('/referral-link', 'User\UserController@referral_link')->name('user-referral-link');
    ...
    Route::get('/testimonial', 'Front\FrontendController@testimonial')->name('front.testimonial');
    Route::get('/testimonial/{slug}', 'Front\FrontendController@testimonialshow')->name('front.testimonialshow');
    Route::get('/testimonial/category/{slug}', 'Front\FrontendController@testimonialcategory')->name('front.testimonialcategory');
    Route::get('/testimonial/tag/{slug}', 'Front\FrontendController@testimonialtags')->name('front.testimonialtags');
    Route::get('/testimonial-search', 'Front\FrontendController@testimonialsearch')->name('front.testimonialsearch');
    Route::get('/testimonial/archive/{slug}', 'Front\FrontendController@testimonialarchive')->name('front.testimonialarchive');
  
    Route::get('/brand-story', 'Front\FrontendController@brand')->name('front.brand-story');
    Route::get('/how-to-use', 'Front\FrontendController@how_to_use')->name('front.how-to-use');
...
Route::post('the/genius/ocean/2441139', 'Front\FrontendController@subscription');
Route::get('finalize', 'Front\FrontendController@finalize');
Route::post('getPinCodeDetails', 'Front\FrontendController@getPinCodeDetails');

Route::post('cancelWaybill/{id}', 'Admin\OrderController@cancelWaybill');
